...
# all output in the file testresults. The two command line arguments are both 
...
# Redirection has to be embedded in the test definition. Each test definition 
# also determines the extent of automatic result checking, of which there are 
# two forms, compare the output display (from rene) to what the test expects 
# and checking the directory for expected changes. If a test defines these 
# they are unconditionally executed. 
# 
# ............................ FUNCTIONS ...................................
...
# collision avoidance (-S bit 1) to show the origin of some new names caused by
...
# is rejected because 4 > 0. 
    return engine(r'IMAG?.JPG/0,0459-0462 tree*.jpg -AS', [], campics, [
'Rename IMAG0459.JPG to tree0459.jpg',
'Rename IMAG0460.JPG to tree0460.jpg',
'Rename IMAG0461.JPG to tree0461.jpg',
'Rename IMAG0462.JPG to tree0462.jpg'])
...
# IMAG461.JPG is the only one to pass the filter.
    return engine(r'IMAG?.JPG/0,459-462 tree*.jpg -AS', [], campics, [
'Rename IMAG461.JPG to tree461.jpg'])
...
# makes the name 4610. Option -X+ tells to use + instead.
    return engine(r'IMAG?.JPG/0,#459-462 tree?.jpg S/0/3 -AS -X+', [], campics, [
...
# replaced by a value synthesized by insert-increment replacement rule.
    return engine(r'IMAG?.JPG/0,#459-462 tree/:.jpg I -AS', [], campics, [
...
# fields, inherently avoiding collision.
    return engine(r'IMAG?.JPG/0,#459-462 tree?.jpg B/-459 -AS', [], campics, [
...
# semantic and must be processed after the RE filter.
    return engine(r'I?G?.JPG/2/0,#458-462 *tree*.jpg  -AS', [], campics, [
...
# Alphabetic range semantic filter with unlimited width.
    return engine(r'my?/0,DEF-MNO his* -AS', [], alphaRange, [
'Rename myDEF to hisDEF',
'Rename myGHI to hisGHI',
'Rename myJKL to hisJKL',
...
# Alphabetic range with Bump (default +1) in replacement.
    return engine(r'my?/0,DEF-MNO his? B -AS', [], alphaRange, [
...
# Alphabetic range with Bump -2 in replacement.
    return engine(r'my?/0,DEF-MNO his? B/-2 -AS', [], alphaRange, [
...
# of borrow. JKL - 10 = JKB, an instance where borrow is not needed.
    return engine(r'my?/0,DEF-MNO his? B/-10 -AS', [], alphaRange, [
...
endFunc = 97 # For ALL limit last test name + 1
